...
public class CreateAccountTest extends BaseUITest {
    ...
    public void fillUpTheFormClickOnCreateAccountBtnAndValidateUserNavigatesToSignUpPageAndValidateEmailAsExpected(){
        clickOnElement(homePage.createPrimaryAccountBtn);
        sendText(createAccountPage.userEmail,"Naqib@gmail.com");
        sendText(createAccountPage.firstName,"Naqibullah");
        ...
        sendText(createAccountPage.userLastName,"Ahmadzai");
        selectFromDropDown(createAccountPage.maritalStatus,"Married");
        sendText(createAccountPage.dateOfBirth,"01/01/1900");
        ...
        String expectedEmail = "Naqib@gmail.com";
    ...
    public void createAccountWithExistingEmailAndValidateErrorMessageAzsExpected(){
        ...
        String expectedErrorMessage = "Account with email Naqib@gmail.com is exist";
